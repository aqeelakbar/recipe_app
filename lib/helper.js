exports.handleJSON = function(json) {
  return json.recipes.slice(0, 10);
}
exports.searchRecipes = function(json, keywords){
  let results = [],
...
exports.singleRecipe = function(json, title) {
...
exports.queryHandler = function(query) {
